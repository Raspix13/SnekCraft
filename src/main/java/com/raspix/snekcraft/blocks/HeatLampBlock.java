...
public class HeatLampBlock extends Block {
    ...
    private static final VoxelShape WIRE_AABB = Block.box(7F, 4F, 7F, 9F, 16F, 9F);
    private static final VoxelShape LAMP_AABB = Block.box(3F, 1F, 3F, 13F, 4F, 13F);

    public HeatLampBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public @NotNull VoxelShape getCollisionShape(BlockState state, BlockGetter worldIn, BlockPos pos, CollisionContext context) {
        ...
        shape = Shapes.join(shape, LAMP_AABB, BooleanOp.OR);
