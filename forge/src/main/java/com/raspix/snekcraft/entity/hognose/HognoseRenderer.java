...
public class HognoseRenderer extends MobRenderer<HognoseEntity, HognoseModel<HognoseEntity>> {
    ...
    private static int maxColor = 12;
    ...
    private static final ResourceLocation LAVENDER_NORMAL_TEXTURE = new ResourceLocation(SnekCraft.MOD_ID, "textures/entity/hognose/lavender_normal.png");
    private static final ResourceLocation LAVENDER_CONDA_TEXTURE = new ResourceLocation(SnekCraft.MOD_ID, "textures/entity/hognose/lavender_conda.png");
    private static final ResourceLocation LAVENDER_SUPERCONDA_TEXTURE = new ResourceLocation(SnekCraft.MOD_ID, "textures/entity/hognose/lavender_superconda.png");


    private static final ResourceLocation[][] TEXTURES = new ResourceLocation[][]{
            {NORMAL_TEXTURE, ALBINO_NORMAL_TEXTURE, AXANTHIC_NORMAL_TEXTURE, ARCTIC_NORMAL_TEXTURE, SNOW_NORMAL_TEXTURE, SUPER_ARCTIC_NORMAL_TEXTURE, SUBZERO_NORMAL_TEXTURE, YETI_NORMAL_TEXTURE, RAINBOW_TEXTURE, ALBINO_ARCTIC_NORMAL_TEXTURE, AXARCTIC_NORMAL_TEXTURE, SUPER_AXARCTIC_NORMAL_TEXTURE, LAVENDER_NORMAL_TEXTURE},
            {CONDA_TEXTURE, ALBINO_CONDA_TEXTURE, AXANTHIC_CONDA_TEXTURE, ARCTIC_CONDA_TEXTURE, SNOW_CONDA_TEXTURE, SUPER_ARCTIC_CONDA_TEXTURE, SUBZERO_CONDA_TEXTURE, YETI_CONDA_TEXTURE, RAINBOW_TEXTURE, ALBINO_ARCTIC_CONDA_TEXTURE, AXARCTIC_CONDA_TEXTURE, SUPER_AXARCTIC_CONDA_TEXTURE, LAVENDER_CONDA_TEXTURE},
            {SUPERCONDA_TEXTURE, ALBINO_SUPERCONDA_TEXTURE, AXANTHIC_SUPERCONDA_TEXTURE, ARCTIC_SUPERCONDA_TEXTURE, SNOW_SUPERCONDA_TEXTURE, SUPER_ARCTIC_SUPERCONDA_TEXTURE, SUBZERO_SUPERCONDA_TEXTURE, YETI_SUPERCONDA_TEXTURE, RAINBOW_TEXTURE, ALBINO_ARCTIC_SUPERCONDA_TEXTURE, AXARCTIC_SUPERCONDA_TEXTURE, SUPER_AXARCTIC_SUPERCONDA_TEXTURE, LAVENDER_SUPERCONDA_TEXTURE}
    };
