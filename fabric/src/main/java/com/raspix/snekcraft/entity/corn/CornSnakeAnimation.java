...
public class CornSnakeAnimation {
    ...
    public static final Animation hide = Animation.Builder.create(0.0F)
            ...
            .addBoneAnimation("head", new Transformation(Transformation.Targets.TRANSLATE,
                    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(-2.0F, -2.0F, 15.0F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(48.2259F, 56.6459F, 39.9655F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body2", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(6.5762F, 79.5755F, 9.796F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body3", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0563F, 74.947F, -0.8375F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body4", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(-2.5228F, 63.6529F, -3.6598F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body5", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(4.3009F, 71.6142F, 2.512F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body6", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(-5.9704F, 69.8514F, -5.259F), Transformation.Interpolations.LINEAR)
            ))
            .addBoneAnimation("body7", new Transformation(Transformation.Targets.ROTATE,
